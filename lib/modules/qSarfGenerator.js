	...
	function sarfGenerator(root, formNum, withColor) {
		...
		if(isVowel(thirdRoot)){ //naaqis
		  ...
		  if(secRoot==thirdRoot){//mudhaaf
			  ...
			  masdr = masdr + "&nbsp&nbsp"+ "وَ"+ "&nbsp&nbsp"+ "مُ" + firstRoot + "ا" +secRoot+"َّةً";
			  ...
			  command = command + "&nbsp&nbsp"+ firstRoot+ "َا" +secRoot+ "ِّ";
			  command = command + "&nbsp&nbsp"+ firstRoot+ "َا" +secRoot+ "ِ" +thirdRoot+ "ْ";
			  
			  forbid = " لا  "+"تُ"+firstRoot+ "َا" +secRoot+ "َّ";
			  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تُ"+firstRoot+ "َا" +secRoot+ "ِّ";
			  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تُ"+firstRoot+ "َا" +secRoot+ "ِ" +thirdRoot+"ْ";
			  ...
			  masdr = masdr + "&nbsp&nbsp"+"وَ" + "&nbsp&nbsp"+ "مُ" + firstRoot + "ا" +secRoot+"َ"+"اةً";
			  ...
			  masdr = beginMasdr+secRoot+"ا"+thirdRoot+"ًا";
			  masdr = masdr + "&nbsp&nbsp"+ "وَ" + "&nbsp&nbsp"+ "مُ" + firstRoot + "ا" +secRoot+"َ"+thirdRoot+"َ"+"ةً";
		  ...
		  if(isVowel(thirdRoot)){ //naaqis and lafeef maqroon(acts like naaqis)
			  ...
			  command = command + "&nbsp&nbsp"+ "أَ" +firstRoot+ "ِ" +secRoot+ "ِّ";
			  command = command + "&nbsp&nbsp"+ "أَ" +firstRoot+ "ْ" +secRoot+ "ِ" +thirdRoot+ "ْ";
			  
			  forbid = " لا  "+"تُ"+firstRoot+ "ِ" +secRoot+ "َّ";
			  forbid = forbid + "&nbsp&nbsp"+" لا  "+"تُ"+firstRoot+ "ِ" +secRoot+ "ِّ";
			  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تُ"+firstRoot+ "ْ" +secRoot+ "ِ" +thirdRoot+ "ْ";   
			...
			if(isVowel(thirdRoot)){
			  ...
			  command = command + "&nbsp&nbsp"+ "تَ"+firstRoot+ "َا" +secRoot+ "ِّ";
			  command = command + "&nbsp&nbsp"+ "تَ"+firstRoot+ "َا" +secRoot+ "ِ" +thirdRoot+ "ْ";
			  
			  forbid = " لا  "+"تَتَ"+firstRoot+ "َا" +secRoot+ "َّ";
			  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تَتَ"+firstRoot+ "َا" +secRoot+ "ِّ";
			  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تَتَ"+firstRoot+ "َا" +secRoot+ "َ" +thirdRoot+"ْ";
		  ...
		  if(isVowel(firstRoot)&&isVowel(thirdRoot)){
			  ...
			  command = command + "&nbsp&nbsp"+"اِ"+firstRoot + "ْتَ" + secRoot + "ِّ";
			  command = command + "&nbsp&nbsp"+"اِ"+firstRoot + "ْتَ" + secRoot + "ِ"+thirdRoot+"ْ";
			  forbid = " لا  "+"تَ"+firstRoot +"ْتَ" + secRoot + "َّ";
			  forbid = forbid + "&nbsp&nbsp"+" لا  "+"تَ"+firstRoot +"ْتَ" + secRoot +"ِّ";
			  forbid = forbid + "&nbsp&nbsp"+" لا  "+"تَ"+firstRoot +"ْتَ" + secRoot + "ِ"+thirdRoot+"ْ";
		  } else {
		  ...
		  command = command + "&nbsp&nbsp"+ "اِ" +firstRoot+ "ْ" +secRoot+ "َ" +thirdRoot+ "ِّ";
		  command = command + "&nbsp&nbsp"+ "اِ" +firstRoot+ "ْ" +secRoot+ "َ" +thirdRoot+ "ِ"+thirdRoot+ "ْ";
		  
		  forbid = " لا  "+"تَ"+firstRoot+ "ْ" +secRoot+ "َ" +thirdRoot+ "َّ";
		  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تَ"+firstRoot+ "ْ" +secRoot+ "َ" +thirdRoot+ "ِّ";
		  forbid = forbid + "&nbsp&nbsp"+ " لا  "+"تَ"+firstRoot+ "ْ" +secRoot+ "َ" +thirdRoot+ "ِ"+thirdRoot+ "ْ";
